export const ROLES = ['admin', 'superviseur', 'caissier', 'accueil', 'auditeur', 'recouvrement'] as const
...
export const MOCK_USERS = [
  ...
  { id: '4', nom: 'Clarisse Recouvrement', initiales: 'CR', role: 'recouvrement' as Role, caisse: null, identifiant: 'recouvrement', motDePasse: '1234' },
]
